var BeautyZone = (function () {
  ...
  var e = $(window).width(),
    ...
    a = function (e) {
      ...
      jQuery(".navbar-nav-scroll > li").each(function () {
        ...
        n.offset().top - i - 20 <= t && n.offset().top + n.height() > t
    ...
    W = function () {
      jQuery(window).on("resize", function () {
        jQuery(".modal:visible").each(D),
          jQuery(".equal-wraper").length && h(".equal-wraper .equal-col"),
          u();
      });
    },
    F = function () {
  ...
  (monthNames = [
    ...
    (I = I.getDate() + " " + monthNames[I.getMonth()] + " " + I.getFullYear());
  var P = function () {
  ...
  return {
    init: function () {
      q(),
        ...
        Z(),
        M(),
        jQuery(".modal").on("show.bs.modal", D);
    },
    load: function () {
      T(), w(), k(), h(".equal-wraper .equal-col"), v(), p(), E();
    },
