                    ...
                    <div class="row">
                                ...
                                <ul class="no-margin">
                                    ...
                                    <li class="icon-bx-wraper left">
                                        ...
                                        <div class="icon-content">
                                            ...
                                            <p>+91 <?= $contact['phone'] ?> , +91 <?= $contact['wp_number'] ?></p>
                                        </div>
                                    </li>
                                </ul>
                                <div class="m-t20">
                                    <ul class="dlab-social-icon dlab-social-icon-lg">
                                        <li><a target="_blank" href="<?= $contact['facebook'] ?>" class="fa fa-facebook bg-primary"></a></li>
                                        <li><a target="_blank" href="<?= $contact['twitter'] ?>" class="fa fa-twitter bg-primary"></a></li>
                                        <li><a target="_blank" href="<?= $contact['linkdin'] ?>" class="fa fa-linkedin bg-primary"></a></li>
                                        <li><a target="_blank" href="<?= $contact['instagram'] ?>" class="fa fa-instagram bg-primary"></a></li>
                        ...
                        <div class="col-lg-4 col-md-6 m-b30">
                            <div class="p-a30 bg-gray clearfix">
                                ...
                                <form method="post" class="dzForm" action="<?= $site ?>util/send_mail.php">
                                    <input type="hidden" value="Contact" name="dzToDo">
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="form-group">
                                                <div class="input-group">
                                                    <input name="fname" type="text" required class="form-control" placeholder="Your Name">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-lg-12">
